class LeftNavMenu
{
    ...
    //ইজারা & Sub Menus 
    getAssetTypeSubMenu()  //Lease/Asset Type 
    {
        return cy.get(' a[href*="asset/lease/lease-type/list"]')
    }
    getleaseAttributeSubMenu()  // Attribute 
    {
        return cy.get('a[href*="asset/lease/lease-attribute/list"]')
    }
    getleaseAttributeMapping()
    {
        return cy.get('a[href*="asset/lease/type-attribute-mapping/list"]')
    }
    
    getLeaseArea()   //Lease Area
    {
        return cy.get(' a[href*="asset/lease/lease-area/list"]')
    }
    getLeaseAbleAsset()
    {
     
        return cy.get('a[href*="asset/lease/lease-item/list"]')

    }
    getContractList()
    {
        return cy.get('a[href*="web/ast/asset/rent/rent-list"]:eq(0)')
    }
    getContractRenewal()
    {
        return cy.get('a[href*="asset/rent/rent-list-by-party"]')
    }
